...
public class KamarRecyclerAdapter extends RecyclerView.Adapter <KamarRecyclerAdapter.RoomViewHolder> implements Filterable {

    private List<KamarDAO> dataList;
    private List<KamarDAO> filteredDataList;
    private Context context;

    public KamarRecyclerAdapter(List<KamarDAO> dataList, Context context) {
    ...
    public RoomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.recycle_adapter_kamar, parent, false);
    ...
    public void onBindViewHolder(@NonNull RoomViewHolder holder, int position) {
        ...
        holder.mParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DetailKamarFragment dialog = new DetailKamarFragment();
