...
import com.pbp.tubes.uas.richhotel.Fragment.DetailKamarFragmentReservasi;
import com.pbp.tubes.uas.richhotel.R;

import java.util.List;
import java.util.stream.Collectors;

public class ReservasiRecyclerAdapterUser extends RecyclerView.Adapter <ReservasiRecyclerAdapterUser.RoomViewHolder> implements Filterable {

    private List<KamarDAO> dataList;
    private List<KamarDAO> filteredDataList;
    private Context context;

    public ReservasiRecyclerAdapterUser(List<KamarDAO> dataList, Context context) {
    ...
    @NonNull
    @Override
    public ReservasiRecyclerAdapterUser.RoomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.recycler_adapter_kamar_reservasi, parent, false);
        return new ReservasiRecyclerAdapterUser.RoomViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ReservasiRecyclerAdapterUser.RoomViewHolder holder, int position) {
        ...
        holder.mParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DetailKamarFragmentReservasi dialog = new DetailKamarFragmentReservasi();
