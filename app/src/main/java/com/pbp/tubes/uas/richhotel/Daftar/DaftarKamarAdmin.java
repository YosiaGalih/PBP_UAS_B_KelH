...
public class DaftarKamarAdmin extends AppCompatActivity {

    private ImageButton ibBack;
    private RecyclerView recyclerView;
    private KamarRecyclerAdapter recyclerAdapter;
    ...
    private void loadKamar() {
        ...
        callGetKamar.enqueue(new Callback<KamarResponse>() {
            ...
            public void onFailure(Call<KamarResponse> call, Throwable t) {
                Toast.makeText(DaftarKamarAdmin.this, "Kesalahan Jaringan", Toast.LENGTH_LONG).show();
                swipeRefreshLayout.setRefreshing(false);
            }
        });
    }
    ...
    private void generateDataList(List<KamarDAO> kamarList) {
        ...
        recyclerAdapter = new KamarRecyclerAdapter(kamarList, this);
