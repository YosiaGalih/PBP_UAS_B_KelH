...
import com.pbp.tubes.uas.richhotel.Adapter.ReservasiAdminRecyclerAdapter;
...
public class DaftarReservasiAdmin extends AppCompatActivity {

    private ImageButton ibBack;
    private RecyclerView recyclerView;
    private ReservasiAdminRecyclerAdapter recyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.daftar_reservasi_admin);
        ...
        callGetTransaksi.enqueue(new Callback<TransaksiResponse>() {
            ...
            public void onResponse(Call<TransaksiResponse> call, Response<TransaksiResponse> response) {
                try {
                    ...
                    Toast.makeText(DaftarReservasiAdmin.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void generateDataList(List<TransaksiDAO> transaksiList) {
        ...
        recyclerAdapter = new ReservasiAdminRecyclerAdapter(transaksiList, this);
